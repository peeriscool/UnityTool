...
/// 
/// </summary>
public class OldUIManager
{
    private static OldUIManager Instance; //singleton
    ...
    public OldUIManager(UIDocument Ui)
    {
    ...
    private void Startproject() //should be divided in to different load functions for Json and creating a new project
    {
